...
> = {
  strategy: {
    idle: require('../assets/office/employee-strategy-seated-rig-v5.png'),
    reviewing: require('../assets/office/employee-strategy-seated-rig-v5.png'),
  },
  reviewer: {
    idle: require('../assets/office/employee-reviewer-seated-idle-rig-v5.png'),
    reviewing: require('../assets/office/employee-reviewer-seated-review-rig-v5.png'),
  },
};
